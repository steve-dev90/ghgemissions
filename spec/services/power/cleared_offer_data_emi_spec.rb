...
RSpec.describe Power::ClearedOfferData do
  ...
  #   test_u1 = "Date,TradingPeriod,Island,PointOfConnection,Trader,Type,ClearedEnergy (MW),ClearedFIR (MW),ClearedSIR (MW)\r\n" +
  #     "2019-07-18,1,NI,WRK2201 WRK0,WRKO,ENOF,50.000,.000,.000\r\n"
  #   test_u2 = "Date,TradingPeriod,Island,PointOfConnection,Trader,Type,ClearedEnergy (MW),ClearedFIR (MW),ClearedSIR (MW)\r\n" +
  ...
  #   allow(HTTParty).to receive_message_chain(:get, :gsub =>  test_u1)
  ...
  #   allow(HTTParty).to receive_message_chain(:get, :body => ho)
  #   allow(HTTParty).to receive_message_chain(:get, :gsub =>  test_u2)
  #   @cleared_offer = Power::ClearedOfferDataEMI.new('./spec/services/power/emi_cleared_offers_test_data/')
  #   @cleared_offer.call
  #   pp TempHalfHourlyEmission.all
  # end
